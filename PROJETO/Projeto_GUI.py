...
dados = carregaDADOS(r"C:\Users\beatr\Desktop\universidade\2º ano\1º semestre\Algoritmos e Técnicas de Programação\projeto final\final\ataMedicaPapers.json")
# ----------------------------------------------------------------------
